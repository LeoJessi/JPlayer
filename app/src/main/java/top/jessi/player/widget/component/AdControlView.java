package top.jessi.player.widget.component;
...
import top.jessi.videoplayer.controller.ControlWrapper;
import top.jessi.videoplayer.player.VideoView;
import top.jessi.videoplayer.util.PlayerUtils;
...
public class AdControlView extends FrameLayout implements IControlComponent, View.OnClickListener {
    ...
    private void doMute() {
        ...
        mVolume.setImageResource(mControlWrapper.isMute() ? top.jessi.videocontroller.R.drawable.dkplayer_ic_action_volume_up : top.jessi.videocontroller.R.drawable.dkplayer_ic_action_volume_off);
    }
