package top.jessi.player.app;

import androidx.multidex.MultiDexApplication;

import com.danikula.videocache.Logger;

import top.jessi.player.BuildConfig;
import top.jessi.videoplayer.exo.ExoMediaPlayerFactory;
import top.jessi.videoplayer.player.VideoViewConfig;
...
public class MyApplication extends MultiDexApplication {
    ...
    public void onCreate() {
        ...
        VideoViewManager.setConfig(VideoViewConfig.newBuilder()
                ...
                /** 软解，支持格式较多，可通过自编译so扩展格式，结合 {@link top.jessi.player.widget.videoview.IjkVideoView} 使用更佳 */
//                .setPlayerFactory(IjkPlayerFactory.create())
//                .setPlayerFactory(AndroidMediaPlayerFactory.create()) //不推荐使用，兼容性较差
                /** 硬解，支持格式看手机，请使用CpuInfoActivity检查手机支持的格式，结合 {@link top.jessi.player.widget.videoview.ExoVideoView} 使用更佳 */
                .setPlayerFactory(ExoMediaPlayerFactory.create())
//                .setPlayerFactory(VlcPlayerFactory.create())
//                .setRenderViewFactory(VlcRenderViewFactory.create(true))
