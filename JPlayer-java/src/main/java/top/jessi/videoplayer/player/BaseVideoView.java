...
import top.jessi.videoplayer.R;
import top.jessi.videoplayer.controller.BaseVideoController;
import top.jessi.videoplayer.controller.MediaPlayerControl;
...
public class BaseVideoView<P extends AbstractPlayer> extends FrameLayout
    ...
    protected void addDisplay() {
        ...
        // 因为VLC特殊的原因，他的TextureView或者SurfaceView是在其内部实现的，所以增加这样的判断，来获取正确的RenderViewFactory
